...
public class TemporalShellRenderer extends OrbitingEffectRenderer {
    // 基础模型资源标识符
    public static final Identifier modelId_base = new Identifier(Soulstone.ID,"effect/temporal_shell");
